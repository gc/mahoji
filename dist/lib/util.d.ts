...
import { APIApplicationCommandOption, APIApplicationCommandOptionChoice, APIChatInputApplicationCommandInteraction, APIChatInputApplicationCommandInteractionDataResolved, APIInteractionGuildMember, APIInteractionResponseCallbackData, RESTPostAPIApplicationGuildCommandsJSONBody, Snowflake } from 'discord-api-types/v9';
...
export declare function handleAutocomplete(command: ICommand | undefined, autocompleteData: AutocompleteData[], member: APIInteractionGuildMember): Promise<APIApplicationCommandOptionChoice[]>;
