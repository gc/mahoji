...
async function handleAutocomplete(command, autocompleteData, member) {
    ...
    if (optionBeingAutocompleted &&
        ...
        const autocompleteResult = await optionBeingAutocompleted.autocomplete(value, member);
