...
export declare type CommandOption = {
    ...
    autocomplete?: (value: string, user: APIUser, member?: APIInteractionGuildMember) => Promise<APIApplicationCommandOptionChoice[]>;
} | {
    ...
    autocomplete?: (value: number, user: APIUser, member?: APIInteractionGuildMember) => Promise<APIApplicationCommandOptionChoice[]>;
    min_value?: number;
    max_value?: number;
} | {
