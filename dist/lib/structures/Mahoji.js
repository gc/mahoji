        ...
        if (interaction.type === 4 /* ApplicationCommandAutocomplete */) {
            ...
            return {
                response: {
                    ...
                    data: {
                        choices: await (0, util_1.handleAutocomplete)(command, options, member)
                    }
                },
        ...
        if (interaction.type === 2 /* ApplicationCommand */) {
            ...
            const apiResponse = response === null
                ...
                : typeof response === 'string'
                    ? { data: { content: response }, type: 4 /* ChannelMessageWithSource */ }
                    : { data: { ...response }, type: 4 /* ChannelMessageWithSource */ };
